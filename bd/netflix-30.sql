...
CREATE TABLE `rel_movies_actors` (
  ...
  `actors_idActor` int DEFAULT NULL,
  `movies_idMovie` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_idActor_idx` (`actors_idActor`),
  KEY `fk_idMovie_idx` (`movies_idMovie`),
  CONSTRAINT `fk_idActor` FOREIGN KEY (`actors_idActor`) REFERENCES `actors` (`idActor`),
  CONSTRAINT `fk_idMovie` FOREIGN KEY (`movies_idMovie`) REFERENCES `movies` (`idMovies`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rel_movies_users` VALUES (1,1),(2,1),(2,2);
...
-- Dump completed on 2023-10-30 11:21:09
